<%-- 
    ...
    Created on : Jul 15, 2024, 2:25:50 PM
    Author     : NgocHung_ighoorbeos
--%>

<%@ page import="models.CartItem, models.User" %>
                    ...
                    <div class="row">
                        <div class="text-center">
                            ...
                            <div class="breadcrumbs">
                                <span class="item">
                                    <a href="./CartDetailController" class=" btn" >YOUR CART ==> </a>
                                </span>
                                <span class="item text-decoration-underline btn">CHECK OUT CONTACT</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <form class="form-group">
                    <div class="row d-flex flex-wrap">
                        ...
                        <div class="col-lg-6">
                            <!-- Check if 'user' attribute is not null -->
                        <c:choose>
                            <c:when test="${not empty user}">
                                <!-- Form for user information -->
                                <form action="${pageContext.request.contextPath}/CartContactController" method="post">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <h3 class="mb-3">Billing Details</h3>
                                            <div class="billing-details">
                                                <label for="fname">Full Name*</label>
                                                <input type="text" id="fname" name="fullname" class="form-control mt-2 mb-4 ps-3" 
                                                       value="${user.fullName}" placeholder="Enter your full name" required>

                                                <label for="gender">Gender*</label>
                                                <select class="form-select form-control mt-2 mb-4" id="gender" name="gender" required>
                                                ...
                                                <input type="text" id="adr" name="address1" class="form-control mt-3 ps-3 mb-3" 
                                                       value="${user.address}" placeholder="Enter your street address" required>

                                                <label for="phone">Phone *</label>
                                                <input type="text" id="phone" name="phone" class="form-control mt-2 mb-4 ps-3" 
                                                       value="${user.mobile}" placeholder="Enter your phone number" required>
                        ...
                        <c:forEach var="cartItem" items="${cartItems}">
                            <div class="card-item">
                                ...
                                <div class="card-details">
                                    <h5>${cartItem.product.description}</h5>
                    ...
                    <div class="col-lg-6">
                        <div class="cart-totals padding-medium pb-0">
                            ...
                            <form action="cart_completion" method="post">
                                <!-- Các tr??ng bi?u m?u khác -->
