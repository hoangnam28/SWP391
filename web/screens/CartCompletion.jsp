...
<section class="cart-completion padding-large">
    <div class="container">
        <h2 class="titleCart">Cart Completion</h2>
        <div class="order-summary">
            <h3 class="mb-3">Thank you for your order!</h3>
            <p>Your order has been submitted successfully. Please review the details below:</p>
...
-->                <p>Please follow the instructions sent to your email for completing the payment.</p>
                <p><strong>Bank Account:</strong> <img id="qrCodeImg" alt="QR Code" /></p>  <!--
            </div>-->
        </div>
        ...
        <div class="side-bar">
            ...
            <div class="latest-products">
                ...
                <ul>
                    <li><a href="ProductDetails?id=1">Product 1</a></li>
                    <li><a href="ProductDetails?id=2">Product 2</a></li>
                    <li><a href="ProductDetails?id=3">Product 3</a></li>
                     Thêm các sản phẩm mới nhất nếu cần 
                </ul>
            </div>
...
<script>
        function generateQrCode(data) {
            ...
            const headers = {
                'x-client-id': '35a757de-2016-40d4-a450-ba951b25d622',
                'x-api-key': '4940af21-166f-4629-aaf8-ee002d6cd6ba',
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            .catch(error => {
                console.error('Error setting QR code image:', error);
            });
        });
    </script>
