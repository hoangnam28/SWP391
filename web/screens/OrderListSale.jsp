            ...
            <table class="table table-bordered">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th><a href="orders_list?sortField=receiver_name&sortOrder=${sortOrder eq 'ASC' ? 'DESC' : 'ASC'}">Customer Name</a></th>
                        <th>Product</th>
                        <th>Images</th>
                ...
                <tbody>
                    <c:forEach var="order" items="${orders}">
                        <tr>
                            ...
                            <td><img src="${pageContext.request.contextPath}/images/${order.productThumbnail}" alt="Product Thumbnail" style="max-width: 100px;" ></td>
            ...
            <nav aria-label="Page navigation">
                <ul class="pagination">
                    <c:if test="${currentPage > 1}">
                        <li class="page-item">
                            <a class="page-link" href="orders_list?page=${currentPage - 1}" aria-label="Previous">
                    ...
                    <c:forEach var="i" begin="1" end="${totalPages}">
                        <li class="page-item ${i == currentPage ? 'active' : ''}">
                            <a class="page-link" href="orders_list?page=${i}">${i}</a>
                        </li>
                    </c:forEach>
                    <c:if test="${currentPage < totalPages}">
                        <li class="page-item">
                            <a class="page-link" href="orders_list?page=${currentPage + 1}" aria-label="Next">
