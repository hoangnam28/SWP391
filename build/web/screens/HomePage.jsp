<%-- 
    Document   : HomePage
    Created on : May 16, 2024, 4:23:58 PM
    Author     : YOUR NAM
--%>
    ...
    <head>
        ...
        <style>
            ...
            .blog-item {
                margin-bottom: 20px;
                text-align: center;
                height: 400px; /* Đặt chiều cao cố định cho các mục bài đăng */
                display: flex;
        ...
        <section id="latest-posts">
            <div class="container">
                ...
                <c:forEach var="post" items="${latestPosts}">
                    <div class="col-md-4">
                        <div class="card blog-item border rounded-3">
                            <a href="${pageContext.request.contextPath}/post_details?id=${post.id}">
                                <img src="${post.thumbnail}" class="img-fluid thumbnail" alt="${post.title}">
                                <h5>${post.title}</h5>
                                <p>${post.briefInfo}</p>
                            </a>
                        </div>
...
<!--    <section id="customers-reviews" class="position-relative">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="card position-relative text-left p-5 border rounded-3">
                            <blockquote>“I stumbled upon this tech store while searching for a new laptop, and I couldn't be happier with my experience! The staff was incredibly knowledgeable and guided me through the process of choosing the perfect device for my needs. Highly recommended!”</blockquote>
                    ...
                    <div class="swiper-slide">
                        <div class="card position-relative text-left p-5 border rounded-3">
                            <blockquote>“This tech store is my go-to for all things tech! Whether it's a new smartphone, accessories, or even troubleshooting advice, they've always got me covered. The staff is friendly, and their expertise is unmatched. Trust me; you won't regret shopping here!”</blockquote>
                            <div class="rating text-primary">
                                <svg class="star star-fill">
                                <use xlink:href="#star-fill"></use>
                                </svg>
                    ...
                    <div class="swiper-slide">
                        <div class="card position-relative text-left p-5 border rounded-3">
                            <blockquote>“I recently purchased a smartwatch from this tech store, and I'm absolutely thrilled find the perfect fit with my purchase! Not only did they have an extensive find the perfect fit selection to choose from, but their team helped me find the perfect fit for my lifestyle.”</blockquote>
                            <div class="rating text-primary">
                                <svg class="star star-fill">
                                <use xlink:href="#star-fill"></use>
                                </svg>
    ...
    <!-- host post -->
    <section id="host-posts" class="padding-large">
        <div class="container">
            <div class="section-title overflow-hidden mb-4">
                <h3 class="d-flex align-items-center">Host Posts</h3>
            </div>
            <div class="row">
                <c:forEach var="hostpost" items="${hostPosts}">
                    <div class="col-md-3 hostposts mb-4">
                        <a class="btn rounded-0 py-0 px-2">${category}</a>
                        <img src="${hostpost.thumbnail}" alt="post image" class="img">
                        <h4 class="card-title mt-3 mb-2 text-uppercase text-dark">
                            <a href="${pageContext.request.contextPath}/post_details?id=${hostpost.id}">${hostpost.title}</a>
                        </h4>
                        <p class="mb-2">${hostpost.briefInfo}</p>
                    </div>
                </c:forEach>
            </div>
        </div>
